function a = Withoutnorm_Align(method, array, reLen, name, data, label, char2, char3, resizedseg_dir)
% 等长对齐不归一化
foldername = strcat(method,'_',char2{2},'_',char3{1});
...
a = 'Complete Method: Withoutnorm_Align';